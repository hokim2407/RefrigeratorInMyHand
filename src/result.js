    ...
    <div className="top-block">
      <div className="background fill-background">
        ...
        >
          ...
          >
            <div style={{}}>
            <p id="answer" className="h2 button-text" style={{ margin: "0", fontSize: "min(5vw, 4rem)", paddingBlockStart: "3vw", color: "white", textDecoration: "underline", textUnderlinePosition: "under" }}>
            <img
